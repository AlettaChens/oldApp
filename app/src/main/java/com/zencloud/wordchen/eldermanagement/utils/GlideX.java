package com.zencloud.wordchen.eldermanagement.utils;
...
public class GlideX {
	...
	public static final int placeholderImage = R.mipmap.img_washclothes;
	public static final int errorImage = R.mipmap.img_washclothes;
